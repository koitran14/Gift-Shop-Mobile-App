...
export default function CheckoutScreen ({navigation, route}) {
    const { selectedProducts, quantities } = route.params;
    ...
    const grandTotal = (parseFloat(totalProductCost) + DELIVERY_COST).toFixed(2);
        ...
        >
            ...
            >
                ...
                {selectedProducts.map((product, index) => (
                    <View key={index} style={styles.productContainer}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Text style={styles.productShop}>Shop Name {/* Add Shop name from server*/}</Text>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={styles.rightInstance}>{totalProductCost}$</Text>
                </View>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <Text style={styles.leftInstance}>Delivery service</Text>
                    <Text style={styles.rightInstance}>{DELIVERY_COST}$</Text>
                </View>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <View style={styles.totalContainer}>
                    ...
                    <Text style={styles.rightInstance}>{grandTotal}$</Text>
                </View>
